      ...
      >
        <div className='relative z-20 col-span-12 lg:col-span-6'>
          ...
          <p className='text-sm md:text-center lg:text-left text-gray-500 mt-4'>
            Connect, engage, and grow your community with Rise, the modern community relationship
            management platform for creators.
          </p>
          <div className='flex justify-center lg:justify-normal mt-8 gap-4'>
            <Button className='bg-gradient-to-br from-purple-500 to-cyan-500'>Explore</Button>
      ...
      <div className='min-w:h-screen flex flex-col lg:px-40 px-8 py-4 gap-24'>
        <div className='flex flex-col'>
          <div className='w-full flex justify-between'>
            <h1 className='text-xl md:text-3xl font-extrabold'>Top Communities</h1>
          </div>
        ...
        <div className='flex flex-col'>
          <div className='w-full flex flex-col text-center gap-4'>
            ...
            <h1 className='md:text-6xl text-4xl font-extrabold'>Building Deeper Connections</h1>
            <p className='text-md text-center text-gray-500 max-w-screen-sm mx-auto'>
              Foster meaningful connections with your community through curated Twitter lists and
              interactive initiatives. Enhance engagement, nurture relationships, and create a
              thriving community ecosystem that fosters collaboration, support, and growth.
            </p>
          </div>
          <div className='w-full grid grid-cols-12 gap-4 mt-24'>
            <div className='col-span-12 lg:col-span-6 gap-8 flex flex-col'>
              <div>
                ...
                <h1 className='text-2xl font-bold'>Experience Token-Gated Curated Twitter Lists</h1>
                <p className='text-md text-gray-500 mt-4'>
                  Discover and stay connected with your beloved communities on Twitter through our
                  innovative token-gated lists. Immerse yourself in the platform you love while
                  seamlessly exploring curated content and fostering meaningful connections.
                </p>
              </div>
              <div>
                <div className='p-2 bg-gray-800 inline-block rounded-lg'>
                ...
                <p className='text-md text-gray-500 mt-4'>
                  Interact effortlessly with your community directly on Twitter using our
                  token-gated lists. Leave the worry of identifying real holders to us as we ensure
                  authenticity. Explore curated timelines effortlessly, scrolling through carefully
                  selected content that resonates with your interests.
                </p>
              </div>
            </div>
